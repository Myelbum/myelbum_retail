...
import 'package:myelbum_retail/ui/data_layer/screens/main_pages/new_income_order.dart';
import 'package:myelbum_retail/ui/data_layer/screens/main_pages/setting/notification/index_notification.dart';
import 'package:myelbum_retail/ui/data_layer/screens/main_pages/setting/reset_password/index_reset_page.dart';
import 'package:myelbum_retail/ui/data_layer/screens/main_pages/setting/security/index_security.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: InkWell(
          onTap: () {
            buildPage(context, const NewIncomeOrder());
          },
          child: RichText(
            text: TextSpan(
                text: "MyElbum",
      ...
      body: (() {
        Widget contentPage = Container();

        if (currentPage == 0) {
          contentPage = SizedBox(
            width: size.width,
            height: size.height,
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  customStepButton(
                      size, isSales ? "NEW SALE" : "PURCHASE VOLUME", () async {
                    if (isSales) {
                      showAlertDialog(
                          context,
                          size,
              ...
              child: Column(
                children: [
                  ...
                  ListTile(
                    ...
                    onTap: () {
                      buildPage(context, const NotificationPage());
                    },
                  ),
                  ListTile(
                    title: const Text("Security"),
                    onTap: () {
                      buildPage(context, const SecurityPage());
                    },
                  ),
                  ListTile(
